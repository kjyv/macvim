...
- (void)loadView {
    ...
    MMFileBrowserCell *cell = [[[MMFileBrowserCell alloc] initWithFileBrowser:fileBrowser] autorelease];
    ...
    pathControl = (MMPathControl*)[[MMPathControl alloc] initWithFrame:NSMakeRect(0, 0, 0, 20) parent:fileBrowser];
